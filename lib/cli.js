...
function getArgsForPage(mod, options, rendererOptions) {
  return {
    pages: [
      {
        page: mod,
...
function getArgsForBooklet(booklet, _, rendererOptions) {
  return {
    pages: booklet.pages,
    options: { ...booklet.options, ...rendererOptions }
  };
}
...
function cli(argv) {
  ...
  if (options.help) {
    ...
    return modArgsMap[modType](mod, options, rendererOptions);
  }
}
