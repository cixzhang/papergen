...
class Renderer {
  constructor(options) {
    ...
    // TODO: use ratio to determine height, 100% width
  ...
  renderPage(module, options) {
    const pageEl = this.createPage();
    pageOptions = module.validateOptions(options);
    page.render(pageEl, options, this.options);
  }
